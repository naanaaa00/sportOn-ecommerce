...
const HeroSection = () => {
    return(
        ...
        <section 
        id="hero-section" 
        className="container x-auto h-screen flex"
        >
            <div className="relative self-center">
                ...
                <div className="relative ml-40 w-full">
                    ...
                    <h1 className="font-extrabold text-[95px] italic bg-linear-to-b leading-light from-black to-[979797] bg-clip-text text-transparent">
